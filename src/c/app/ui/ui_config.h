...
#define UI_FONT_KEY_SPLASH_LOGO                                                                                        \
    UI_FONT_KEY_FOR_SIZE(UI_FONT_KEY_SPLASH_LOGO_SMALL, UI_FONT_KEY_SPLASH_LOGO_MEDIUM, UI_FONT_KEY_SPLASH_LOGO_LARGE, \
                         UI_FONT_KEY_SPLASH_LOGO_XLARGE)

#define UI_FONT_KEY_SPLASH_LOADING                                                                                     \
    UI_FONT_KEY_FOR_SIZE(UI_FONT_KEY_SPLASH_LOADING_SMALL, UI_FONT_KEY_SPLASH_LOADING_MEDIUM,                          \
                         UI_FONT_KEY_SPLASH_LOADING_LARGE, UI_FONT_KEY_SPLASH_LOADING_XLARGE)

// Images
#define UI_IMAGE_KEY_KAGI_NEWS_LOGO_SMALL RESOURCE_ID_IMAGE_KAGI_NEWS_25
#define UI_IMAGE_KEY_KAGI_NEWS_LOGO_MEDIUM RESOURCE_ID_IMAGE_KAGI_NEWS_25
#define UI_IMAGE_KEY_KAGI_NEWS_LOGO_LARGE RESOURCE_ID_IMAGE_KAGI_NEWS_40
#define UI_IMAGE_KEY_KAGI_NEWS_LOGO_XLARGE RESOURCE_ID_IMAGE_KAGI_NEWS_40

#define UI_IMAGE_RESOURCE_FOR_SIZE(small, medium, large, xlarge)                                                       \
    ((preferred_content_size() == PreferredContentSizeSmall)        ? (small)                                          \
     : (preferred_content_size() == PreferredContentSizeLarge)      ? (large)                                          \
     : (preferred_content_size() == PreferredContentSizeExtraLarge) ? (xlarge)                                         \
                                                                    : (medium))

#define UI_IMAGE_KEY_KAGI_NEWS_LOGO                                                                                    \
    UI_IMAGE_RESOURCE_FOR_SIZE(UI_IMAGE_KEY_KAGI_NEWS_LOGO_SMALL, UI_IMAGE_KEY_KAGI_NEWS_LOGO_MEDIUM,                  \
                               UI_IMAGE_KEY_KAGI_NEWS_LOGO_LARGE, UI_IMAGE_KEY_KAGI_NEWS_LOGO_XLARGE)
 ...
 */
#define UI_SCALE_FOR_SIZE_INFERRED(val)                                                                                \
...
#define UI_SCALE_FOR_SIZE(small, medium, large, xlarge)                                                                \
    ((preferred_content_size() == PreferredContentSizeSmall)        ? (small)                                          \
     : (preferred_content_size() == PreferredContentSizeLarge)      ? (large)                                          \
     : (preferred_content_size() == PreferredContentSizeExtraLarge) ? (xlarge)                                         \
                                                                    : (medium))

#define UI_SPLASH_LOGO_ICON_X_FUDGE UI_SCALE_FOR_SIZE(4, 4, 8, 8)

// Layout
#define UI_MENU_X_PADDING_BASE 6
#define UI_MENU_X_PADDING UI_SCALE_FOR_SIZE_INFERRED(UI_MENU_X_PADDING_BASE)

#define UI_MENU_CELL_PADDING_Y_BASE 4
#define UI_MENU_CELL_PADDING_Y UI_SCALE_FOR_SIZE_INFERRED(UI_MENU_CELL_PADDING_Y_BASE)

#define UI_MENU_CELL_HEIGHT_BASE 40
#define UI_MENU_CELL_HEIGHT_DEFAULT UI_SCALE_FOR_SIZE_INFERRED(UI_MENU_CELL_HEIGHT_BASE)
...
#define UI_DETAIL_SIDE_PADDING UI_SCALE_FOR_SIZE_INFERRED(UI_DETAIL_SIDE_PADDING_BASE)

#define UI_DETAIL_BETWEEN_PADDING_BASE 6
#define UI_DETAIL_BETWEEN_PADDING UI_SCALE_FOR_SIZE_INFERRED(UI_DETAIL_BETWEEN_PADDING_BASE)

#define UI_DETAIL_BOTTOM_PADDING_BASE 8
#define UI_DETAIL_BOTTOM_PADDING UI_SCALE_FOR_SIZE_INFERRED(UI_DETAIL_BOTTOM_PADDING_BASE)
...
#define UI_SPLASH_LOGO_TOP_MARGIN UI_SCALE_FOR_SIZE_INFERRED(UI_SPLASH_LOGO_TOP_MARGIN_BASE)

#define UI_SPLASH_LOGO_HEIGHT_BASE 24
#define UI_SPLASH_LOGO_HEIGHT UI_SCALE_FOR_SIZE_INFERRED(UI_SPLASH_LOGO_HEIGHT_BASE)

#define UI_SPLASH_LOADING_HEIGHT_BASE 22
#define UI_SPLASH_LOADING_HEIGHT UI_SCALE_FOR_SIZE_INFERRED(UI_SPLASH_LOADING_HEIGHT_BASE)

#define UI_SPLASH_LOADING_Y_OFFSET_BASE 30
#define UI_SPLASH_LOADING_Y_OFFSET UI_SCALE_FOR_SIZE_INFERRED(UI_SPLASH_LOADING_Y_OFFSET_BASE)

#define UI_QR_Y_FUDGE_BASE 24
#define UI_QR_Y_FUDGE UI_SCALE_FOR_SIZE_INFERRED(UI_QR_Y_FUDGE_BASE)

#define UI_QR_LOADING_TEXT_HEIGHT_BASE 24
#define UI_QR_LOADING_TEXT_HEIGHT UI_SCALE_FOR_SIZE_INFERRED(UI_QR_LOADING_TEXT_HEIGHT_BASE)
...
static inline uint32_t ui_get_kagi_news_logo_image_handle(void)
{
    return UI_IMAGE_KEY_KAGI_NEWS_LOGO;
}
