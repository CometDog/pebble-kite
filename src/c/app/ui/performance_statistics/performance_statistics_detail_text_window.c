#include "performance_statistics_detail_text_window.h"
...
{
    detail_text_window_ui_init_with_default_handlers(&s_detail_window, DETAIL_TYPE_PERFORMANCE_STATISTICS, false);
}
